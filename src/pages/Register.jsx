...
const Register = () => {
  ...
  const sendNewUserInfo = async (w) => {
    ...
    const response = await axios
      .post("http://websitebuild.herokuapp.com/api/auth-customer/register",{first_name,second_name,email,address,password,password_confirmation,phone_number,city},{headers:{shop:"remonshop"}})
      .catch((err) => {
